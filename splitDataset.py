...
class SplitDataset():
    def __init__(self, dataset_dir, saved_dataset_dir, train_ratio=0.7, test_ratio=0.1, show_progress=False):
...
if __name__ == '__main__':
    split_dataset = SplitDataset(dataset_dir="OriginalDataset",
